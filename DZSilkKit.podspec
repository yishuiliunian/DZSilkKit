...
Pod::Spec.new do |s|
  s.name             = "DZSilkKit"
  s.version          = "0.1.0"
  s.summary          = "A short description of DZSilkKit."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/DZSilkKit"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "stonedong" => "yishuiliunian@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/DZSilkKit.git", :tag => s.version.to_s }
